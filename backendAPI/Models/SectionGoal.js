...
var CreateSectionGoal = function(req,res,next){
   var vals = [req.body.ID,req.body.Year,req.body.CourseName,req.body.Semester,req.body.GoalsID, req.body.GAPlus, req.body.GA,req.body.GAMinus ,req.body.GBPlus,req.body.GB ,req.body.GBMinus,req.body.GCPlus ,req.body.GC ,req.body.GCMinus,req.body.GDPlus,req.body.GD ,req.body.GDMinus ,req.body.GF,req.body.GW,req.body.GI]  
